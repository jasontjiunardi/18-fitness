...
public class UserController {
    ...
    public String processPasswordReset(Model model, @ModelAttribute User user,
            @RequestParam("recoveryCode") int recoveryCode, @RequestParam("newPassword") String newPassword) {
        User retrievedUser = userService.getUserByEmail(user.getEmail());
    ...
    @GetMapping("/profile")
    public String userProfile(Model model, @SessionAttribute("user") User user) { // user in User user hold attribute
                                                                                  // from session attribute "user" atau
                                                                                  // itu masuk ke User user
        User retrievedUser = userService.getUserByEmail(user.getEmail());
    ...
    public String userEditInformation(@RequestParam("image") MultipartFile multipartFile, @ModelAttribute User user,
    ...
    // public String showProfilePictureUploadForm(Model model,
